...
function TubePulse({ size = "medium", color = "blue" }: TubePulseProps) {
    const sizeClass ={
     small: "w-4 h-4" ,
     medium: "w-12 h-12" ,
     large: "w-16 h-16",
  ...
  return <div className={`${sizeClass[size]} ${colorClasses[color]} rounded-full animate-pulse`}/>
}

export default TubePulse